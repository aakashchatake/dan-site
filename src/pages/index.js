      ...
      <main className="homepage">
        ...
        <section className="intro-block" style={{paddingTop: '2.5rem'}}>
          ...
          <div className="intro-text">
            ...
            <div style={{marginTop: '1rem', display: 'flex', gap: '.75rem', justifyContent: 'center', flexWrap: 'wrap'}}>
              <Link className="button button--primary" to={useBaseUrl('unit01')}>Start Unit 1</Link>
              <Link className="button button--secondary" to={useBaseUrl('assessments')}>Assessments</Link>
              <Link className="button button--secondary" to={useBaseUrl('practicals')}>Practicals</Link>
            </div>
          </div>
        </section>
        ...
        <section className="why-analytics">
          ...
          <ul style={{margin: 0, paddingLeft: '1rem'}}>
            <li><span className="highlight-pill">Clarity</span> — concise theory with worked examples.</li>
            <li><span className="highlight-pill">Reproducibility</span> — code, datasets, and versioned notes.</li>
            <li><span className="highlight-pill">Assessment</span> — unit-wise tests, orals, and prelims.</li>
            <li><span className="highlight-pill">Practice</span> — practicals and microprojects with instructor guides.</li>
          </ul>
        </section>
        ...
        <section className="explore-portal">
          ...
          <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(220px,1fr))', gap:'0.75rem'}}>
            ...
            <Card title="Lecture Archive" href="https://chatakeedusphere.sharepoint.com/:f:/s/DATAANALYTICS/Ehz-dQUmGt1Nn2piFWDCKgEBfTc5cfKgOxyWOuqFJXVPMQ?e=Pt9U3r" external desc="Slides, recordings & materials." />
          </div>
        </section>
        ...
        <section className="explore-portal">
          ...
          <ul style={{listStyle:'none', padding:0, margin:0}}>
            <li style={{marginBottom:'.5rem'}}>
              <a href="https://mindforgeai.wordpress.com/2025/06/03/entropy-the-silent-architect-of-time-thought-and-the-cosmos/"
            ...
            <li style={{marginBottom:'.5rem'}}>
              <a href="https://teams.microsoft.com/l/team/19%3AQV7eesuvh2MSQJOS-1hKWHl13i22WqQcxC-vW3dgzSQ1%40thread.tacv2/conversations?groupId=cba02c1e-dd92-4e1e-b217-3d55af5f0f21&tenantId=6b08a6ba-973d-4a9a-b855-91f27bac00e6"
                 target="_blank" rel="noopener noreferrer">
...
function Card({title, to, href, external = false, desc}) {
  ...
  return <Link to={useBaseUrl(to)} style={{textDecoration:'none'}}>{content}</Link>;
}
